...
<html>
    ...
    <body>
        <main class="container py-5">
            <div class="card">
                <img class="card-img-top" src="images/header3.png" alt="Card image cap">
                <div class="d-flex justify-content-between">
                    <div class="bg-light  rounded">
                        <div class="card-body little-profile">
                            <div class="d-flex align-items-start">
                                <div class="pro-img" style="margin-top: -50px;">
                                    <img src="images/icon4.jpg" alt="user">
                                </div>
                    ...
                    <div class="bg-transparent p-4 text-center">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item">
                                <h5 class="font-weight-bold mb-0 d-block">17,789</h5>
                                <small class="text-muted"><i class="fas fa-user mr-1"></i>Seguidoras</small>
                            </li>
                            <li class="list-inline-item">
                                <h5 class="font-weight-bold mb-0 d-block">8520</h5>
                    ...
                    <div class="col-md-4">
                        <div class="p-5  rounded" style="background-color:#FFC9DA; margin-left:5%; margin-down:5%;">
                            ...
                            <div class="text-center" >
                                ...
                                <a href="https://twitter.com/bruxlt" target="_blank"><img class="social"  src="images/x.svg" alt="twitter"></a>
                            ...
                            <div class="p-4 mb-3 bg-light rounded">
                                ...
                                <div class="container marketing">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6">
                                            <a href="#"><img class="portada" src="images/8.png" alt=""></a>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-6">
